          ...
          >
            <Card>
              <CardHeader className="text-center pb-4">
                ...
                <CardDescription>
                  Kurir uses passkeys for secure, passwordless sign-in.
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        Your device (Touch ID, Face ID, or security key) becomes your login.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
          ...
          >
            <Card>
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-2xl">You&apos;re in, {displayName.split(" ")[0]}!</CardTitle>
                <CardDescription>
                  Your account is secured with a passkey.
                  Now connect your first email account to get started.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Button
